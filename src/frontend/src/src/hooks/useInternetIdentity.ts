...
export function InternetIdentityProvider({
  ...
  // Stable ref for auth client — never causes re-renders or effect loops
  const authClientRef = useRef<AuthClient | null>(null);
  // Stable ref for createOptions so callbacks don't need it in deps
  ...
  const clear = useCallback(() => {
    ...
    void client
      ...
      .then(() => {
        ...
        setStatus("idle");
        setError(undefined);
        // Re-create so a fresh login works after logout
